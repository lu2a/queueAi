...
import { Tv, LayoutDashboard, Settings } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl w-full">
        {menuItems.map((item) => (
          <button
            ...
            className={`${item.color} hover:scale-105 transition-all text-white p-12 rounded-[2.5rem] shadow-2xl flex flex-col items-center gap-6 group`}
          >
